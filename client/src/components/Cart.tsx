                            ...
                            >
                                <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                                        ...
                                                        return (product?.quantity > 0 && <li key={i} className="flex py-6">
                                                            ...
                                                            <div className="ml-4 flex flex-1 flex-col">
                                                                ...
                                                                <div className="flex flex-1 items-end justify-between text-sm">
                                                                    ...
                                                                    {/* <div className="flex">
                                                                        <button onClick={()=>handleRemovefromCart(i)} type="button" className="font-medium text-indigo-600 hover:text-indigo-500">
                                                                            Remove
                                                                        </button>
                                                                    </div> */}
                                                                </div>
                                    ...
                                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                            <p>Subtotal</p>
                                            <p>{allProductsTotal==0 ?'No items added':allProductsTotal}</p>
                                        </div>
                                        <div className="mt-6">
                                            <a
                                                href="#"
